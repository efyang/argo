...
(define (gengame ptype blocknum) (list ptype 500 blocknum (basemap blocknum) (list 0 0 0) (list 1 -200 -200)))
...
(define (mainrender gamesize blocknum boardmap piecenums pmoveinfo)
...
(define (render model)
  (mainrender (second model) (third model) (fourth model) (fifth model) (sixth model)))
...
;/heyboard/hitbox functions

(mainrender 500 19 (blkmap 19) (countpieces (blkmap 19)) (list 1 (/ (getblocksize 500 19) 2) (/ (getblocksize 500 19) 2)))
(render (gengame 0 19))